    ...
    <Icon name="calendar" size={20} color="#707070" style={{ alignSelf: 'center' }} /></TouchableOpacity>
      ...
      <TouchableOpacity onPress={() => markFavorite(item)} >
        <View style={{ alignItems: 'flex-end', padding: 10 }}>
          ...
          <Icon color={'green'} name={employer.favorites.filter((item1) => item1.CandidateId == item.CandidateId).length == 0 ? 'heart-o' : 'heart'} size={15} style={{ marginTop: -27, marginRight: 6.5 }}></Icon>
