        ...
        <View style={{ flex: 1 }}>
            {auth.profile != null ? (
                <>
                    ...
                    {auth.profile.PortFolios.length > 0 && <View style={[styles.view, { marginBottom: 30 }]}>
                        <View style={styles.view2}>
                            <Text style={styles.text4}>Resumes</Text>
                        </View>
                        {
                            auth.profile.PortFolios.map((item) => <Image resizeMode="contain" source={{ uri: "https://lms.phenomenaltechnology.com" + item.Path }} style={{ margin: 15, width: 100, height: 100 }}></Image>)
                        }
                        {/* <Image
                            resizeMode="contain"
