        ...
        <View style={styles.drawerContent}>
            ...
            <View
              ...
              <View style={{flexDirection: 'column'}}>
                <Title style={[styles.title, {alignSelf: 'center'}]}>
                  {props.auth.profile != null && props.auth.profile.CompanyName}
                </Title>
          ...
          <Drawer.Section style={styles.bottomDrawerSection}>
            ...
            <DrawerItem
              icon={({color, size}) => (
                <Image
                  ...
                  source={require('../assests/image/profile1.png')}
                />
              )}
            ...
            <DrawerItem
              icon={({color, size}) => (
                <Image
                  resizeMode="contain"
                  style={{width: 25, height: 20, tintColor: '#009961'}}
                  source={require('../assests/image/case.png')}
                />
              )}
              label="Jobs"
              labelStyle={{color: 'white'}}
            ...
            <DrawerItem
              ...
              labelStyle={{color: 'white'}}
              onPress={() => {
                props.navigation.navigate('BrowseCandidates');
              }}
            />
            <DrawerItem
              icon={({color, size}) => (
                <IIcon name="ios-heart" color="#009961" size={size} />
              )}
              label="Favorites"
              labelStyle={{color: 'white'}}
              onPress={() => {
            ...
            <DrawerItem
              ...
              labelStyle={{color: 'white'}}
              onPress={() => {
                props.navigation.navigate('Hired');
              }}
            />
          </Drawer.Section>
        </View>
