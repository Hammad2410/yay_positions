                ...
                <View style={styles.drawerContent}>
                    <View style={styles.userInfoSection}>
                        <View style={{ flexDirection: 'column', marginTop: 15, alignItems: 'center' }}>
                            <Avatar.Image
                                source={{
                                    uri: props.auth.profile != null ? 'https://lms.phenomenaltechnology.com/' + props.auth.profile.Profile.ProfileImage : 'https://api.adorable.io/avatars/50/abott@adorable.png'
                                }}
                                size={50}
                                style={{ alignSelf: "center" }}
                            />
                            <View style={{ flexDirection: 'column' }}>
                                <Title style={styles.title}>{props.auth.profile != null && props.auth.profile.Profile.Email}</Title>
                    ...
                    <Drawer.Section style={styles.bottomDrawerSection}>
                        ...
                        <DrawerItem
                            icon={({ color, size }) => (
                                <Image resizeMode='contain' style={{ width: 25, height: 20, tintColor: '#009961' }} source={require('../assests/image/email.png')} />
                        ...
                        <DrawerItem
                            icon={({ color, size }) => (
                                <Image resizeMode='contain' style={{ width: 25, height: 20, tintColor: '#009961' }} source={require('../assests/image/save.png')} />
