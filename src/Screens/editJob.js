...
const EditJob = ({ navigation, employer, editJob, resetModal, route }) => {
    ...
    const [qualification, setQualification] = useState(route.params.job.Qualification);
    ...
    const [jobDescription, setJobDescription] = useState(route.params.job.JobDescription);
    const [detail, setDetail] = useState(route.params.job.Detail);
    const [location, setLocation] = useState(route.params.job.Location);
    const [remoteOrInHouse, setRemoteOrInHouse] = useState(route.params.job.RemoteOrInHouse);
            ...
            <Content >
                ...
                <View style={{ flex: 1 }}>
                    ...
                    <View style={{ marginTop: 10, alignItems: 'center' }}>
                        ...
                        <TextInput placeholder="Details" placeholderTextColor='#707070' style={styles.textinput} value={detail}
                        ...
                        {!employer.loading ? <TouchableOpacity style={styles.button} onPress={() => editJob(title, level, experience, qualification, jobType, salaryType, salaryRange, jobDescription, detail, location, remoteOrInHouse, id, posted)} >
                            <View >

                                <Text style={{ textAlign: 'center', marginTop: 5, color: '#009961', fontWeight: 'bold' }} >Edit Job</Text>
                            </View>
